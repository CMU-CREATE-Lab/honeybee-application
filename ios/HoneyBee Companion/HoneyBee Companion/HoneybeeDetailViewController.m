...
//	[self.wifiUpdateButton setTitle:[[NSBundle mainBundle] localizedStringForKey: @"honeybee.dfu.wifi.updateButton.inProgressTitle" value: @"Wifi Updating ..." table: nil] forState: UIControlStateNormal];
//
...
//			[self.wifiUpdateButton setTitle:[[NSBundle mainBundle] localizedStringForKey: @"honeybee.dfu.wifi.updateButton.title" value: @"Update Wifi Firmware" table: nil] forState: UIControlStateNormal];
//		}
//		
//	}];
}
